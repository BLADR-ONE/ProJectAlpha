        ...
        <div className={styles.text_box}>
          ...
          <p className={`${styles["p"]} ${styles["p__a_and_c"]}`}>Vrei să ne conctactezi?<br/>
           ...
           <div className={styles.icons}>
             <li className={styles.li}><a href="https://github.com/IRules" style={{color: '#f1f2f3'}}>GitHub: Toma Aris</a> </li>
             <li className={styles.li}><a href="https://github.com/BLADR-ONE" style={{color: '#f1f2f3'}}>GitHub: Ureche Rafael</a></li>
           </div>
